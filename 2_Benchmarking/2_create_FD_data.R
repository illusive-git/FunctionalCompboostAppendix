...
cbd = Compboost$new(data = df_train,target = response_test,learning_rate = 0.3,loss = LossQuadratic$new(),
                    time_spline_pars = list(n_knots = 14, degree = 3, penalty = 10))
boostSplines(data = df_train, target = response_test,learning_rate = 0.3,loss = LossQuadratic$new(),
             time_spline_pars = list(n_knots = 14, degree = 3, penalty = 10))
