...
comp_test$addBaselearner(feature = "a",id = "P1",bl_factory = BaselearnerPSpline, penalty = 10, n_knots = 35, degree = 3)
comp_test$train(1, trace = 0) 

fdb_model = FDboost(formula = fun_mat ~ bbs(a, lambda = 10, knots = 35, degree = 3), 
